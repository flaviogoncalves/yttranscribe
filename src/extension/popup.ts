...
const button = document.getElementById("grab") as HTMLButtonElement;
...
button.addEventListener("click", async () => {
  ...
  try {
    ...
    const player = await fetchInPage(tab.id, url, init as Record<string, unknown>);
    ...
    const { episode, warning, trackLanguage, trackIsAutoGenerated } = buildEpisode(
      payload,
      track.body,
      videoId,
      choice,
